...
select distinct address, address_name, project_name from crosschain.core.address_labels where label_subtype = 'bridge' and blockchain = 'avalanche'

),
  to_bridge AS (
  SELECT FROM_ADDRESS as user_address, 
  bridges.project_name as bridge_name, 
  avalanche.core.ez_token_transfers.CONTRACT_ADDRESS as token_contract,
